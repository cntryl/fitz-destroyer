...
const CONFIGS: Partial<Record<ConcreteScenario, CompletionConfig>> = {
  ...
  "actor-supervision-failpoint": {
    ...
    fields: [["domainsInjected", "Domain actor failpoints"], ["readinessWithdrawals", "Readiness withdrawals"], ["restartsRecovered", "Recovered restarts"], ["canaryDeliveries", "Post-restart Notice deliveries"], ["queueRecovered", "Post-restart Queue completions"], ["kvRecovered", "Post-restart KV canaries"], ["leaseRecovered", "Post-restart Lease canaries"]],
  },
};
