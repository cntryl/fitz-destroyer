...
function fallbackScenarioDuration(scenario: ConcreteScenario, events: readonly EventRecord[]): number | null {
  const names: Partial<Record<ConcreteScenario, string>> = {
    ...
    "upgrade-recovery": "upgrade_recovery_complete",
    "cross-transport-recovery": "cross_transport_recovery_complete",
    "outbound-blackhole": "outbound_blackhole_complete",
    "broker-pause": "broker_pause_complete",
    "route-cardinality-churn": "route_cardinality_churn_scenario_complete",
    "cache-and-disk-exhaustion": "cache_and_disk_exhaustion_complete",
    ...
    "lease-route-aliasing": "lease_route_aliasing_complete",
    "tcp-preauth-framing-slowloris": "tcp_preauth_framing_slowloris_complete",
    "connect-pipeline-family-rebind": "connect_pipeline_family_rebind_complete",
    "ephemeral-reply-loss-cleanup": "ephemeral_reply_loss_cleanup_complete",
    "saturated-slow-recipient-isolation": "saturated_slow_recipient_isolation_complete",
    "shutdown-reconnect-cleanup-storm": "shutdown_reconnect_cleanup_storm_complete",
    "control-lane-cleanup-under-saturation": "control_lane_cleanup_under_saturation_complete",
    ...
    "family-actor-degradation-observability": "family_actor_degradation_observability_complete",
    "family-actor-inflight-concurrent-failure": "family_actor_inflight_concurrent_failure_complete",
