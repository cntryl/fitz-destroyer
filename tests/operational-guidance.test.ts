...
function fixtureEvents(scenario: ConcreteScenario): object[] {
  ...
  if (scenario === "actor-supervision-failpoint") return [{ event: "actor_supervision_failpoint_complete", domainsInjected: 2, readinessWithdrawals: 2, restartsRecovered: 2, canaryDeliveries: 4, queueRecovered: 1, elapsedMs: 1_000 }];
  return [];
}
