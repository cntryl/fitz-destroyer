...
function fixtureEvents(scenario: ConcreteScenario): object[] {
  ...
  if (scenario === "actor-supervision-failpoint") return [{ event: "actor_supervision_failpoint_complete", domainsInjected: 7, correlatedDomainsInjected: 7, readinessWithdrawals: 8, restartsRecovered: 8, canaryDeliveries: 4, queueRecovered: 1, kvRecovered: 1, leaseRecovered: 1, scheduleRecovered: 1, streamRecovered: 1, rpcRecovered: 1, correlatedRecoveryOperations: 7, elapsedMs: 1_000 }];
  return [];
}
