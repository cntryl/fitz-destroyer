...
function fixtureEvents(scenario: ConcreteScenario): object[] {
  ...
  if (scenario === "response-envelope-boundaries") return [{ event: "response_envelope_boundaries_complete", domains: 2, exactFit: 2, oneOverRejected: 1, canaryOperations: 2, elapsedMs: 1_000 }];
  return [];
}
