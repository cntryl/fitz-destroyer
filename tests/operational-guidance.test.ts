...
function fixtureEvents(scenario: ConcreteScenario): object[] {
  ...
  if (scenario === "actor-supervision-failpoint") return [{ event: "actor_supervision_failpoint_complete", canaryDeliveries: 4, expectedCanaryDeliveries: 4, elapsedMs: 1_000 }];
  return [];
}
