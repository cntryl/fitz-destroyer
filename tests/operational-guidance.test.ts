...
function fixtureEvents(scenario: ConcreteScenario): object[] {
  ...
  if (scenario === "actor-supervision-failpoint") return [{ event: "actor_supervision_failpoint_complete", domainsInjected: 6, readinessWithdrawals: 6, restartsRecovered: 6, canaryDeliveries: 4, queueRecovered: 1, kvRecovered: 1, leaseRecovered: 1, scheduleRecovered: 1, streamRecovered: 1, elapsedMs: 1_000 }];
  return [];
}
