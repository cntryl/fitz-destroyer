...
function fixtureEvents(scenario: ConcreteScenario): object[] {
  ...
  if (scenario === "actor-supervision-failpoint") return [{ event: "actor_supervision_failpoint_complete", domainsInjected: 3, readinessWithdrawals: 3, restartsRecovered: 3, canaryDeliveries: 4, queueRecovered: 1, kvRecovered: 1, elapsedMs: 1_000 }];
  return [];
}
