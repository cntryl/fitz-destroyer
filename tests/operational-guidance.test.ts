...
function fixtureEvents(scenario: ConcreteScenario): object[] {
  ...
  if (scenario === "response-envelope-boundaries") return [{ event: "response_envelope_boundaries_complete", domains: 6, exactFit: 6, oneOverRejected: 3, boundedAggregates: 2, canaryOperations: 6, elapsedMs: 1_000 }];
  return [];
}
